...
TASK_NAMES=("connected_nodes" "node_degree")
TEXT_ENCS=("adjacency" "friendship")
GRAPH_GENS=("path_er" "sbm_er" "sfn_er" "star_er" "ba_er" "complete_er")
PROMPT_METHOD="cg"
MODEL_NAMES=("GPT35")
...
echo "Evaluations for Table 3 using '$PROMPT_SOURCE' are completed."
